...
// Member 1: Research nav (Includes Viral Launchpad from main)
const researchNav = [
...
const AppSidebar = () => {
  ...
  // Close sidebar drawer on mobile when clicking a navigation link
                    ...
                    <SidebarMenuItem>
                      <SidebarMenuButton asChild>
                        <Button asChild variant="ghost" className='w-full justify-start mt-1'>
                          <Link href="/settings" onClick={handleNavClick} className='w-full flex items-center gap-2'>
